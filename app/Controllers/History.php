...
class History extends BaseController {
    ...
    function mostra_risultato() {
        ...
        echo view('pages/tamponi/mostra_risultato');
    ...
    function history_lab() {
        ...
        echo view('pages/tamponi/history_lab');
    ...
    function mostra_info() {
        ...
        echo view('templates/header_loggedIn_LAB');
        echo view('pages/tamponi/mostra_info');
        echo view('templates/footer_loggedIn_LAB');
    }
    ...
    function set_risultato_lab() {
        ...
        if ($_SESSION['numero_prenotati'] == 1) {
            echo view('templates/header_loggedIn_LAB');
            echo view('pages/tamponi/set_risultato_singolo');
            echo view('templates/footer_loggedIn_LAB');

        } else {

            echo view('templates/header_loggedIn_LAB');
            echo view('pages/tamponi/set_risultato_multiplo');
            echo view('templates/footer_loggedIn_LAB');
        }
    }
    ...
    function set_pos() {
        ...
        $tipologia_test = $_SESSION['tipologia_test'];
        ...
        if (isset($_POST['id'])) {
            ...
            if ($id == 1) {
                ...
                $add = $db->query("INSERT INTO notifiche VALUES (4, '" . $email . "', '" . $email_utente . "', '" . 
                                   $tipologia_test . "', '" . $data . "', '" . $orario . "', " . $numero_prenotati . ", 'UTENTE', CURRENT_TIMESTAMP());");
                ...
                $add = $db->query("INSERT INTO notifiche VALUES (5, '" . $email . "', '" . $email_utente . "', '" . 
                                   $tipologia_test . "', '" . $data . "', '" . $orario . "', " . $numero_prenotati . ", 'UTENTE', CURRENT_TIMESTAMP());");
            ...
            if ($numero_positivi <= $_SESSION['numero_prenotati']) {
                ...
                $add = $db->query("INSERT INTO notifiche VALUES (6, '" . $email . "', '" . $email_utente . "', '" . 
                $tipologia_test . "', '" . $data . "', '" . $orario . "', " . $numero_positivi . ", 'UTENTE', CURRENT_TIMESTAMP());");
            }
        }

...
<form class="book-form" method='post' enctype="multipart/form-data">
    ...
    <h4 class="white-text" style="margin-top:40px;">Carica Questionario Anamnesi (facoltativo):<input type="file" name="questionario" style="border: 3px solid var(--clr-bg); border-radius: 2px; padding: .3em;"></h4>

...
.file {
 ...
 <label for="standard-select"><span>Quando si desidera prenotare il test:</span></label>
  ...
  <input name="hh_test" class="set_tamp" type="number" min="0" max="23" placeholder="23"><a style="color:white">:</a><input name="mm_test" class="set_tamp" type="number" min="0" max="59" placeholder="00">
  </div>
  <div id="element3">

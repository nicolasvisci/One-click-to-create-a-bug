...
$routes->match(['get', 'post'], 'prenotaTestSingolo', 'Prenota::prenotaTestSingolo');
$routes->match(['get', 'post'], 'prenotaTestMultiplo', 'Prenota::prenotaTestMultiplo');
...
$routes->get('prenotazione', 'Prenota::scegli_prenotazione');
$routes->get('prenotazione_singola', 'Prenota::prenotazione_singola');
$routes->get('prenotazione_multipla', 'Prenota::prenotazione_multipla');

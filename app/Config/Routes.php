...
$routes->post('recuperaPassword', 'Dashboard::recuperaPassword');
...
$routes->get('visualizza_notifiche', 'Dashboard::visualizza_notifiche');
...
$routes->post('get_risultato_utente', 'History::get_risultato_utente');
$routes->get('mostra_risultato', 'History::mostra_risultato');
...
$routes->get('get_questionario', 'History::get_questionario');
$routes->post('torna_indietro', 'History::torna_indietro');
$routes->post('get_risultato_lab', 'History::get_risultato_lab');
$routes->get('set_risultato_lab', 'History::set_risultato_lab');
$routes->post('set_pos', 'History::set_pos');
$routes->post('elimina_notifica', 'Notifiche::elimina_notifica');

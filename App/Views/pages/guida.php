...
<header class="w3-container w3-dark w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo w3-text-white">GUIDA TAMPONI</h1>
</header>
...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      <h1>Test molecolare (mediante tampone naso orofaringeo)</h1>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-twothird">
      <h1>Test antigenico rapido (mediante tampone nasale, naso-oro-faringeo, salivare)</h1>
...
<div class="w3-row-padding w3-green w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-twothird">
      <h1>Quando fare il test molecolare</h1>
      <ul>
      ...
      <p class="w3-text-black">In attesa dell’esito del test diagnostico va rispettato l'isolamento domiciliare.</p>
    </div>
  </div>
</div>
</body>
...
<div class="w3-row-padding w3-red w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <div class="w3-twothird">
      <h1>Quando non fare il test molecolare</h1>
